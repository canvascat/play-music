			...
			<div class="liked-songs" @click="goToLikedSongsList">
				...
				<div class="bottom">
					...
					<DropdownMenu>
						...
						<DropdownMenuContent>
							<DropdownMenuItem @click="playLikedSongs"
			...
			<div class="tabs-row">
				<div class="tabs">
					...
					>
						...
						<DropdownMenu>
							<DropdownMenuTrigger @click.stop as-child>
								<span class="icon"><IconArrowDown class="size-4" /></span>
							</DropdownMenuTrigger>
							<DropdownMenuContent>
				...
				<button v-show="currentTab === 'cloudDisk'" class="tab-button" @click="selectUploadFiles">
					<IconArrowUpAlt />{{ $t("library.uploadSongs") }}
				</button>
			</div>
...
import { IconPlay, IconPlus, IconArrowUpAlt, IconArrowDown } from "@/components/icon";
